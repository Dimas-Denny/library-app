              ...
              <div className="flex items-center gap-3">
                <form onSubmit={onSubmitSearch} className="flex items-center">
                  <div className="relative">
                    <svg
                      className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-black/50"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2"
                      viewBox="0 0 24 24"
                    ...
                    <input
                      ...
                      onChange={(e) => setQ(e.target.value)}
                      placeholder="Search book"
                      className="h-10 w-[65vw] rounded-full border border-black/15 bg-white pl-10 pr-4 text-sm"
                    />
                  </div>
                </form>
